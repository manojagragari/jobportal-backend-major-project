...
This project is designed for learning Django in a practical, project-based way.

Students will learn routing, templates, Bootstrap UI, forms, file uploads, authentication, and database integration step-by-step.
